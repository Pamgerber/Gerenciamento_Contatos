package com.example.agendatelefone.dominio.entidades;
...
public class Contato implements Serializable {
    ...
    public static String TIPODATAESPECIAL= "TIPODATAESPECIAL";
    ...
    public void setTipoDataEspecial(String tipoDataEspecial) { this.tipoDataEspecial= tipoDataEspecial; }
